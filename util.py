...
UserData = namedtuple('UserData', ['name', 'key', 'id', 'active', 'permissions'])

UserLoged = namedtuple('UserLoged', ['name', 'email'])

# from util import UserData

profiles = {
    'jalbertcruz@gmail.com': UserData('Albert', 'albert', 'jalbertcruz@gmail.com', True, ['Admin', 'A'])
}
